...
Vagrant Box with Ubuntu 18.04 and jenkins
...
- [elegoev/ubuntu-18.04-jenkins](https://app.vagrantup.com/elegoev/boxes/ubuntu-18.04-jenkins)
...
### Vagrantfile
    ...
    Vagrant.configure("2") do |config|
      ...
      $basebox_name="ubuntu-18.04-jenkins-test"
      ...
      config.vm.define "#{$basebox_name}" do |machine|
        ...
        # forwarding ports
        machine.vm.network "forwarded_port", id: "jenkins",  auto_correct: true, protocol: "tcp", guest: 8080, host: 8080, host_ip: "127.0.0.1"
...
### Access URL
    ...
    http://jenkins.localtest.me:8080
